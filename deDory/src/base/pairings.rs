...
// This is a wrapper around multi_pairing_impl simply because tracing doesn't
...
#[tracing::instrument(level = "debug", skip_all)]
// This is a wrapper around multi_pairing_2_impl simply because tracing doesn't
// work well with threading.
...
#[tracing::instrument(level = "debug", skip_all)]
// This is a wrapper around multi_pairing_4_impl simply because tracing doesn't
// work well with threading.
